 ...
 * @description کۆمپۆنێنتێک بۆ دروستکردنی وێنەی OG بۆ میدیای کۆمەڵایەتی
 */
import { computed } from 'vue'

interface Props {
  title?: string // ناونیشانی سەرەکی
  description?: string // وەسفی وێنەکە
  headline?: string // سەردێڕی سەرەوە
  link?: string // لینکی وێنەی پڕۆفایل (ئەگەر هەبێت)
}
...
// دڵنیابوون لەوەی کە ناونیشان لە 60 پیت زیاتر نەبێت
const title = computed(() => props.title.slice(0, 60))
</script>

<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    <!-- بەشی سەرەوەی ڕاست - شێوەی ڕازاندنەوە -->
    <svg
    ...
    <!-- بەشی ناوەڕاستی وێنەکە - دەق و زانیارییەکان -->
