 ...
 * @modified هەڵوێست ڕەسوڵ - Webs.krd
 */
import { computed } from 'vue'

interface Props {
  title?: string // ناونیشانی بابەت
  description?: string // وەسفی بابەت
  headline?: string // سەردێڕی سەرەوە
  link?: string // لینکی وێنە
}
...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    ...
    <!-- ناوەڕۆکی سەرەکی -->
    <div class="w-[600px] pl-[100px]" dir="rtl">
