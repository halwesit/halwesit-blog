...
<template>
  <div>
    ...
    <div class="my-3 space-x-3 pb-3">
      <NuxtLink
        to="https://github.com/halwest"
        target="_blank"
        class="p-2 bg-gray-300 me-3 text-gray-800 rounded-md dark:bg-sky-700 dark:text-[#F1F2F4]"
        aria-label="Github"
      >
        <Icon name="fa:github" size="1em" />
      </NuxtLink>
      <NuxtLink
        to="https://www.linkedin.com/in/halwest/"
        target="_blank"
      ...
      <NuxtLink
        to="https://facebook.com/halwest.rasul"
        target="_blank"
        class="p-2 bg-gray-300 text-gray-800 rounded-md dark:bg-sky-700 dark:text-[#F1F2F4]"
        aria-label="Facebook"
      >
