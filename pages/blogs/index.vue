...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'لێرەدا هەموو ئەو بابەتانە دەبینیت کە نووسیومە و بڵاوم کردوونەتەوە.',
    },
  ],
})
...
defineOgImage({
  props: {
    title: 'ئەرشیف',
    description: 'لێرەدا هەموو ئەو بابەتانە دەبینیت کە نووسیومە و بڵاوم کردوونەتەوە.',
    ...
    <ClientOnly>
      <div v-auto-animate class="space-y-5 my-5 px-4">
        ...
        <ArchiveCard
          ...
          title="هیچ بابەتێک نەدۆزرایەوە"
          image="/not-found.jpg"
        />
      </div>

      <template #fallback>
        <!-- ئەمە لەسەر سێرڤەر ڕێندەر دەکرێت -->
        <BlogLoader />
        <BlogLoader />
      </template>
    </ClientOnly>
